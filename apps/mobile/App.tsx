...
const createStyles = (theme: MobileTheme) =>
  StyleSheet.create({
    ...
    businessCard: {
      backgroundColor: "rgba(9, 26, 21, 0.94)",
      borderColor: "rgba(235, 178, 80, 0.32)",
      borderRadius: 18,
      borderWidth: 1,
      flex: 1,
      overflow: "hidden",
    ...
    categoryItem: {
      alignItems: "center",
      backgroundColor: "rgba(8, 26, 21, 0.88)",
      borderColor: "rgba(235, 178, 80, 0.22)",
      borderRadius: 13,
      borderWidth: 1,
      flexBasis: "23.4%",
      gap: 8,
    ...
    homeReferenceGlow: {
      backgroundColor: "rgba(8, 91, 58, 0.28)",
      borderRadius: 180,
      height: 260,
      position: "absolute",
      right: -110,
    ...
    tabBar: {
      alignItems: "center",
      backgroundColor: "rgba(5, 15, 13, 0.94)",
      borderColor: "rgba(255, 193, 58, 0.16)",
      borderRadius: 20,
      borderWidth: 1,
      bottom: 16,
