...
const createStyles = (theme: MobileTheme) =>
  StyleSheet.create({
    ...
    businessCard: {
      ...
      borderColor: theme.isDark ? theme.colors.goldSoft : theme.colors.border,
      overflow: "hidden",
    ...
    categoryCardActive: {
      ...
      shadowOpacity: theme.isDark ? 0.24 : 0.13,
      shadowRadius: 18,
    },
    categoryCount: {
      color: theme.colors.mutedForeground,
    ...
    centerTabButton: {
      ...
      shadowColor: theme.colors.deepGold,
      shadowOffset: { height: 12, width: 0 },
      shadowOpacity: theme.isDark ? 0.46 : 0.24,
      shadowRadius: 20,
    ...
    heroCard: {
      ...
      shadowColor: theme.colors.shadow,
      shadowOffset: { height: 26, width: 0 },
      shadowOpacity: theme.isDark ? 0.42 : 0.18,
      shadowRadius: 42,
    },
    heroEyebrow: {
      color: theme.colors.deepGold,
    ...
    logoMark: {
      ...
      shadowColor: theme.colors.deepGold,
      shadowOffset: { height: 12, width: 0 },
      shadowOpacity: theme.isDark ? 0.46 : 0.22,
      shadowRadius: 18,
      width: 48,
    },
    logoText: {
    ...
    primaryButton: {
      ...
      shadowColor: theme.colors.deepGold,
      shadowOffset: { height: 12, width: 0 },
      shadowOpacity: theme.isDark ? 0.42 : 0.22,
      shadowRadius: 20,
    },
    ...
    searchBar: {
      ...
      shadowColor: theme.colors.shadow,
      shadowOffset: { height: 16, width: 0 },
      shadowOpacity: theme.isDark ? 0.23 : 0.1,
      shadowRadius: 24,
    },
    searchIcon: {
      color: theme.colors.gold,
    ...
    tabBar: {
      ...
      shadowColor: theme.colors.shadow,
      shadowOffset: { height: 20, width: 0 },
      shadowOpacity: theme.isDark ? 0.44 : 0.2,
      shadowRadius: 32,
      zIndex: 20,
    },
    tabActiveIndicator: {
