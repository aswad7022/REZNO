...
function createStyles(theme: MobileTheme) {
  return StyleSheet.create({
    ...
    error: { color: theme.colors.danger, fontSize: 14, fontWeight: "700", padding: 8 },
    success: { color: theme.colors.success, fontSize: 15, fontWeight: "900" },
    ...
    secondaryButton: { backgroundColor: theme.colors.card, borderColor: theme.colors.border, borderRadius: 12, borderWidth: 1, minHeight: 44, minWidth: 44, paddingHorizontal: 14, alignItems: "center", justifyContent: "center" },
