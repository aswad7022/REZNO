...
table, privilege, Prisma model, migration, staging fixture, or production
state. Migrations 48 and 49 remain immutable.
...
No Prisma schema or migration changed. The disposable test database applied
49/49 migrations. Stage 6 runtime, staging, production, provider
