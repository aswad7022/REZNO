...
export async function updateBusinessProfile(
  ...
  const forbiddenMediaFields = ["logoUrl", "coverImageUrl", "galleryUrls", "ogImageUrl"];
  if (forbiddenMediaFields.some((field) => formData.has(field))) {
    return { status: "error", message: tMessages("invalid") };
  }
