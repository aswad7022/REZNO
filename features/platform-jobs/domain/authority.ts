...
const PLATFORM_OPERATIONS_AUTOMATION = [
  "PLATFORM_JOBS_MANAGE",
  "PLATFORM_OPERATIONS_MANAGE",
] as const satisfies readonly AdminPermission[];
const COMMERCE_EXPIRY_AUTOMATION = [
  "PLATFORM_JOBS_MANAGE",
...
const JOB_PERMISSIONS = {
  ...
  COMMERCE_ORDER_EXPIRY: COMMERCE_EXPIRY_AUTOMATION,
  PLATFORM_OPERATIONS_MONITOR: PLATFORM_OPERATIONS_AUTOMATION,
  DISTRIBUTED_RATE_LIMIT_CLEANUP: PLATFORM_OPERATIONS_AUTOMATION,
