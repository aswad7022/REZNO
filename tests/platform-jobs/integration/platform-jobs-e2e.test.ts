...
test("migration chain is healthy at 51/51 and additive Stage 6 migrations create no platform rows", async () => {
  ...
  `);
  assert.deepEqual(migrationRows[0], { applied: BigInt(51), failed: BigInt(0), total: BigInt(51) });
