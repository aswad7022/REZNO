...
test("migration chain is healthy at 50/50 and additive Stage 6 migrations create no platform rows", async () => {
  ...
  `);
  assert.deepEqual(migrationRows[0], { applied: BigInt(50), failed: BigInt(0), total: BigInt(50) });
